...
def main():
    ...
    #             ['P', 'P', 'P'],
    #             ['P', 'P', 'P']],
    #     'taxis': {'taxi 1': {'location': (0, 0), 'capacity': 2, 'player': 1},
    #               # 'taxi 2': {'location': (3, 1), 'capacity': 1, "player": 1},
    #               'taxi 3': {'location': (2, 2), 'capacity': 2, "player": 2},
    #               # 'taxi 4': {'location': (2, 3), 'capacity': 1, "player": 2},
    #               },
    #     'passengers': {'Omer': {'location': (2, 1), 'destination': (1, 2), 'reward': 4},
    #                    'Gal': {'location': (0, 2), 'destination': (2, 0), 'reward': 6},
    #                    # 'Reema': {'location': (2, 0), 'destination': (0, 0), 'reward': 7},
    #                    # 'Kobi': {'location': (0, 1), 'destination': (1, 2), 'reward': 3},
    #                    },
    #     'turns to go': 200
    # }
    game = Game(an_input)
